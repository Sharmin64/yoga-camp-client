...
const AddClass = () => {
  ...
  return (
    <section className="bg-indigo-400  my-10 lg:mx-auto sm:ml-64">
      <div className="py-8 px-10 mx-auto max-w-5xl lg:py-16 bg-indigo-400  rounded-xl">
        {/* <h2 className=' text-center text-red-500 mb-10 text-5xl font-bold'>Add Class</h2> */}
        <h2 className="mb-10 text-2xl font-bold text-red-700 dark:text-white">
          Add a new class
        </h2>
        <form className="" onSubmit={handleAddClass}>
          <div className="grid gap-4 sm:grid-cols-3 sm:gap-6">
            ...
            <button
              type="submit"
              className=" text-white text-lg font-semibold bg-red-700 hover:bg-red-800 dark:bg-red-700 dark:hover:bg-red-800 py-3 rounded-md"
            >
              Add Now
            </button>
          </div>
